 ...
 * bajo test importe `../src/env` (que valida con zod al cargar). Se engancha vía
 * `tsx --test --import ./test/setup-env.ts` en el script de test. Usa `??=` para no pisar un
 * `.env` real ya cargado en el shell.
 */
